...
<head>
    ...
    <meta name="author" content="Abubakar Shehu">
	<meta name="generator" content="Jewel ICT Hub" />
    <meta name="robots" content="noindex, nofollow">
    <link rel="shortcut icon" href="assets/img/favicon.png">
    <title>Jewel ICT Hub &rsaquo; Admin Panel</title>
    ...
    <!-- DataTables -->
    <link href="https://cdn.datatables.net/v/bs4/jszip-3.10.1/dt-1.13.8/b-2.4.2/b-html5-2.4.2/r-2.5.0/datatables.min.css" rel="stylesheet">
...
?>" class="nav-link" target="_blank" data-toggle="tooltip" title="Visit Site" data-toggle="tooltip" data-placement="bottom">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<center><a href="dashboard.php" class="brand-link">
      <span class="brand-text font-weight-light"><i class="fab fa-get-pocket"></i> Jewel ICT Hub</span>
    </a></center>
...
<footer class="main-footer">
    ...
    <strong>&copy; <?php
    echo date("Y");
?> <a href="https://gombeirs.com" target="_blank">Jewel ICT Hub</a> v<?php echo $psec_version; ?></strong>
	...
	<script src="https://cdn.datatables.net/v/bs4/jszip-3.10.1/dt-1.13.8/b-2.4.2/b-html5-2.4.2/r-2.5.0/datatables.min.js"></script>

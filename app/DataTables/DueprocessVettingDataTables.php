...
class DueprocessVettingDataTables extends DataTable
{
    ...
    public function query(Invoice $model): QueryBuilder
{
    ...
    //     ->where('revenue_item_name', 'VETTING OF CONTRACT FEES') // Specify the revenue item
    ...
    // Apply filters from the parameters passed via `with()`
    if ($this->agency_name) {
        $query->where('agency_name', $this->agency_name);
    }

    if ($this->revenue_item_name) {
        $query->where('revenue_item_name', $this->revenue_item_name);
    }

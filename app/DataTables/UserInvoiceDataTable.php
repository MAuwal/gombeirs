...
class UserInvoiceDataTable extends DataTable
{
    ...
    public function query(Invoice $model): QueryBuilder
    {
        ...
        //     $query->where('id', auth()->id()); // Assuming the user ID is stored in the 'id' column
        // });
        $user_id = auth()->id();
        
        // search all: working but i want user to search his invoice only
    ...
    //         // Add your search conditions for specific columns
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('id')->title('Transaction Reference')->searchable(),

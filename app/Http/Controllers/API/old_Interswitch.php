...
class Interswitch extends Controller
{
    ...
    public function getInvoiceDetails($payload)
    {
        try {
            ...
            // Verifies existence of Merchant Reference number
            // $merchantRef = (count($info) == 2) ? $info[1] : NULL;
            ...
            // $invoiceItemCode = Invoice::where('item_code', $ProductCode)->first();
            
            
            
            // echo $invoiceItemCode->item_code . "\n";
            // echo $ProductCode . "\n";
            // echo $invoiceItemCode->item_code == $ProductCode;
            
            
            // // TODO
            // Merchant Reference number must be updated from 6405 to the 
            // production value
            ...
            $xmlData = new \SimpleXMLElement('<?xml version="1.0"?><CustomerInformationResponse></CustomerInformationResponse>');
    ...
    private function sendNotificationResponse($paymentLogId, $status)
    {
        ...
        $xmlData = new \SimpleXMLElement('<?xml version="1.0"?><PaymentNotificationresponse></PaymentNotificationresponse>');
        $this->arrayToXml($responseArray, $xmlData);
        $xmlResponse = $xmlData->asXML();

...
<form id="filterForm" method="GET" action="{{ url('/invoices/ConsumptionTaxReport2') }}">
    <div class="label">
...
<form id="monthlyReportForm" method="GET" action="{{ url('/invoices/ConsumptionTaxReport') }}">
    <div class="label">
...
function fetchMonthlyData(revenueItemName, month) {
    fetch(`{{ url('/invoices/ConsumptionTaxReport') }}?revenue_item_name=${revenueItemName}&month=${month}`, {
        headers: {
...
function fetchSubheads(agencyName, detailsRow) {
    fetch(`{{ url('/invoices/ConsumptionTaxReport2') }}?agency_name=${agencyName}`, {
        headers: {
            'X-Requested-With': 'XMLHttpRequest'
        }
    })
...
function fetchPayments(subheadName, paymentsRow) {
    fetch(`{{ url('/invoices/ConsumptionTaxReport2') }}?subhead_name=${subheadName}`, {
        headers: {
            'X-Requested-With': 'XMLHttpRequest'
        }
    })

		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
              ...
              />
						<!--end::Image-->
						<!--begin::Title-->
						<h3 class="text-gray-700 fs-2qx fw-bold text-center mb-7">Verify the Genuineness of your TCC</h3>
						<!--end::Title-->
						
						<div id="invoiceDetailsSection" style="display: none;">
                            
                            <h2>Name: <span id="name"></span></h2>
                            <h2>GTIN: <span id="gtin"></span></h2>
                            <h2>Tax paid 2023 (NGN): <span id="taxpaid"></span></h2>
                            <h2>Tax outstanding 2023 (NGN): <span id="taxout"></span></h2>
                            <h2>Business Status: <span id="status"></span></h2>
                        </div>
							...
							<div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
								...
								<form class="form w-100" novalidate="novalidate" id="kt_new_password_form" data-kt-redirect-url="../../demo25/dist/authentication/layouts/overlay/sign-in.html" action="#">
									...
									<div class="text-center mb-10">
										<!--begin::Title-->
										<h1 class="text-dark fw-bolder mb-3">Input your TIN or GTIN</h1>
										<!--end::Title-->
    ...
    <script>
        $(document).ready(function () {
            $("#kt_new_password_submit").click(function () {
                var refNo = $("input[name='receipt_reference']").val();
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            ...
                            $("#name").text(response.tcc.name);
                            $("#gtin").text(response.tcc.gtin);
                             $("#taxpaid").text(response.tcc.taxpaidyr3);
                             $("#taxout").text(response.tcc.tccType);
                             $("#status").text(response.tcc.business_status);

...
<body>
	...
	<div class="clearfix">
        <table>
            <tr style="color: #fff;">
                ...
                <td>.</td>
                <td> <div class="logo">
                    <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/assets/media/logos/gombe.png'))) }}" class="img"  alt="girs Logo">
              ...
              <!--/>-->
                     ...
                     <!--<img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/assets/media/logos/Coat_of_arms_of_Nigeria.svg'))) }}" class="img2" alt="">-->
            </div></td>
            <td></td>
            </tr>
        </table>
      ...
      <h1 style="text-align:center"> Gombe State Internal Revenue Service</h1>
        <h4 style="text-align:center">ADDRESS: Opposite Custodian Hotel, Along Gombe - Bauchi Road, Gombe, Gombe State</h4>
        <h4 style="text-align:center">PHONE: 08024945888, 09130064676, 09091363075, 09054356142</h4>
       ...
       <h3
		...
		<table>
			...
			<tr>
				<td><b>BN No.</b></td>
				<td>: {{ isset($tcc['rc']) ? $tcc['rc'] : '' }}</td>
			</tr>
			<tr>
				<td><b>Date Of Incorporation</b></td>
				<td>: {{ isset($tcc['date_of_incorporation']) ? date('d-m-Y', strtotime($tcc['date_of_incorporation'])) : '' }}
</td>
			</tr>
            <tr>
				<td><b>GTIN</b></td>
			...
			<tr>
				...
				<td>: {{ isset($tcc['business_address']) ? $tcc['business_address'] : '' }}</td>
			</tr>
			<tr>
				<td></td>
                <td></td>
            ...
            <tr>
				...
				<td>: {{ isset($tcc['business_status']) ? $tcc['business_status'] : '' }}</td>
			</tr>
			<!-- <tr>
				<td>Certification:</td>
				<td>This is to certify that MILES HOSPITAL LIMITED has been cleared for Income Tax purposes following verification of your self-assessment returns filed.</td>
			</tr> -->
		</table>
        <p>has settled his/her income tax assessments for the past three years, i.e 2022, 2023, 2024 </p>
	</div>
	<table>
		<tr>
			<th ></th>
		...
		<tr>
			<td><b>Total Chargeable Income</b></td>
			<td>NGN {{ isset($tcc['Chargeableyr1']) ? $tcc['Chargeableyr1'] : '' }}</td>
			<td>NGN {{ isset($tcc['Chargeableyr2']) ? $tcc['Chargeableyr2'] : '' }}</td>
			<td>NGN {{ isset($tcc['Chargeableyr3']) ? $tcc['Chargeableyr3'] : '' }}</td>
		</tr>
		<tr>
			<td><b>Tax Paid</b></td>
    ...
    <tr>
			...
			<td colspan="2">: {{ isset($tcc['sourcrOfInc']) ? $tcc['sourcrOfInc'] : '' }}</td>
		</tr>
        <tr>
			<td><b>Other Comments</b></td>
			<td colspan="2">: {{ isset($tcc['othercomment']) ? $tcc['othercomment'] : '' }} </td>
		</tr>
        <tr>
		...
		<tr>
			<td><b>Please Note: Any Alteration on this document, render it invalid, Visit https://gombeirs.com to validate the Certificate</b></td>
    ...
    <img align="right" src="data:image/png;base64, {{ base64_encode(QrCode::format('png')->generate('Name: ' . $tcc->name . ' | GTIN: ' . $tcc->gtin . ' | Tax paid 2024 (NGN): ' . $tcc->taxpaidyr3 . ' | Tax Outstanding 2024 (NGN): ' . $tcc->tccType . ' | Business Status: ' . $tcc->business_status)) }}" alt="QR" width="100" class="logo"/>

...
<head>
    ...
    <base href=""/>
    <title>{{ config('app.name', 'Gombe') }}</title>
...
<!--begin::Body-->
<body {!! printHtmlClasses('body') !!} {!! printHtmlAttributes('body') !!}  oncontextmenu="return false">
...
<?php include_once('/home/gombeirs/public_html/security/config.php'); ?>
<?php include_once('/home/gombeirs/public_html/security/project-security.php'); ?>
@livewireScripts
</body>
<!--end::Body-->

...
<body class="section-bg-one">
    <main class="main-wrapper position-relative">
        <div class="modern-invoice2 w-100" id="download-section">
            ...
            <h3 align="center"><strong>GOMBE STATE IGR PLATFORM E-REVENUE RECEIPT</strong></h3>
            <div class="modern-invoice">
                        ...
                        <div class="col-sm-6">
                            <div class="invoice-details mb-20">
                                <div class="invoice-details-inner mt-2">
                                    ...
                                    <p><strong>Taxpayer Name: {{ $invoice->name }}</strong></p>
                                    <p><strong>Taxpayer Name: {{ $invoice->name }}</strong></p>
                                    <p><strong>Taxpayer's Phone Number:  {{ $invoice->phone_number }}</strong></p>
                                    <p><strong>Status:  {{ $invoice->status }}</strong></p>
                                    <p><strong>Invoice for:  {{ $invoice->agency_name }}</strong></p>
                                    <p><strong>Printed by: {{auth()->user()->name }}</strong></p>
                                    <p><strong>Transaction Reference: <span id="transactionRef"></span></strong></p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 mb-10">
                        <span class="status d-block mb-20"> <strong><h3>Receipt No: {{ $invoice->id }}</h3></strong></span>
                    </div>
                </div>

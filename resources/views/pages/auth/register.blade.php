<x-auth-layout>
    ...
    <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="{{ route('login') }}" action="{{ route('register') }}">
        ...
        <div class="text-center mb-11">
            ...
            <!--end::Title-->
            <img alt="Logo" src="{{ image('logos/states.png') }}" class="h-75px app-sidebar-logo-default" />
        ...
        <div class="fv-row mb-8">
            <!--begin::Name-->
            <input type="text" placeholder="Individual, Corporate or Agency Name" name="name" autocomplete="off" class="form-control bg-transparent"/>
            <!--end::Name-->
        </div>
        ...
        <div class="fv-row mb-10">
            <div class="form-check form-check-custom form-check-solid form-check-inline">
                ...
                <label class="form-check-label fw-semibold text-gray-700 fs-6">
                    ...
                    <a href="https://gombe.igr.ng/" class="ms-1 link-primary">Terms and conditions</a>.
                </label>
            </div>
        </div>
        <!--end::Input group--->

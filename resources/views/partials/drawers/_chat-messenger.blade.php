		...
		<div class="card-footer pt-4" id="kt_drawer_chat_messenger_footer">
			...
			<div class="d-flex flex-stack">
				...
				<div class="d-flex align-items-center me-2">
					<button class="btn btn-sm btn-icon btn-active-light-primary me-1" type="button" data-bs-toggle="tooltip" title="                 ">{!! getIcon('paper-clip', 'fs-3') !!}</button>
					<button class="btn btn-sm btn-icon btn-active-light-primary me-1" type="button" data-bs-toggle="tooltip" title="                 ">{!! getIcon('cloud-add', 'fs-3') !!}</button>
				</div>
				<!--end::Actions-->
				<!--begin::Send-->
